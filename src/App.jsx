...
const Card = ({ children, style, accent, form }) => (
  <div style={{
    background: form ? "#1e2a3d" : T.bgCard,
...
function SectionChambres({ data, setData }) {
  ...
  const newE = () => ({ nom:"",code:"",nbUnites:1,capaStd:2,capaMax:3,adultesMax:2,enfantsMax:1,surface:20,configLits:"Double",salleEau:"Douche",descriptif:"",clim:"NON",coffreFort:"NON",minibar:"NON",wifi:"OUI",bureau:"NON",balcon:"NON" });
      ...
      <nav style={{ background:T.bgNav, borderBottom:"1px solid #e5e7eb", padding:"0 32px", height:56, display:"flex", alignItems:"center", justifyContent:"space-between", position:"sticky", top:0, zIndex:200, boxShadow:"0 1px 3px rgba(0,0,0,.08)" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:24 }}>
          <a href="https://oceane-habonneau.github.io/EcosT-v2/#ecosystem" target="_blank" rel="noreferrer"
            style={{ fontSize:13, color:"#64748b", fontFamily:T.font, textDecoration:"none", cursor:"pointer" }}>🔗 Écosystème</a>
          <a href="https://oceane-habonneau.github.io/EcosT-v2/#services" target="_blank" rel="noreferrer"
            style={{ fontSize:13, color:"#64748b", fontFamily:T.font, textDecoration:"none", cursor:"pointer" }}>🔧 Services</a>
          ...
          <button type="button" onClick={() => {
            const subject = encodeURIComponent("Onboarding Hôtelier — " + (data.identity.enseigne || "Nouvel établissement"));
            const body = encodeURIComponent("Bonjour Océane,\n\nVeuillez trouver ci-joint le fichier Excel d'onboarding de l'établissement : " + (data.identity.enseigne || "") + "\n\nCordialement");
            window.location.href = `mailto:oceane.habonneau@gmail.com?subject=${subject}&body=${body}`;
          }} style={{ background:"#3b82f6", color:"#fff", border:"none", borderRadius:8, padding:"7px 16px", fontSize:12, fontWeight:700, cursor:"pointer", fontFamily:T.font, display:"flex", alignItems:"center", gap:5 }}>
            ✉️ Envoyer par mail
          </button>
